    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.profileHeader}>
          <Avatar.Image
            source={{ uri: userInfo.imageUrl || 'https://api.adorable.io/avatars/285/avatar.png' }}
            size={90}
            style={styles.avatar}
          />
        ...
        <DetailIcon label="Name" value={userInfo.name} icon="account" />
            <DetailIcon label="Address" value={userInfo.address} icon="map-marker" />
            <DetailIcon label="Pincode" value={userInfo.pincode} icon="pin" />
            <DetailIcon label="Date of Birth" value={userInfo.dob} icon="calendar" />
            <DetailIcon label="Phone" value={userInfo.phone} icon="phone" />
            <DetailIcon label="Email" value={userInfo.email} icon="email" />
            <DetailIcon label="Aadhaar No" value={userInfo.aadhaarNo} icon="card-account-details" />
            <DetailIcon label="Education" value={userInfo.educationQualification} icon="school" />
            <DetailIcon label="Skill Sector" value={userInfo.skillSector} icon="briefcase" />
            <DetailIcon label="Blood Group" value={userInfo.bloodGroup} icon="water" />
            <DetailIcon label="Experience" value={userInfo.experience} icon="history" />
            <DetailIcon label="Municipality/Panchayath" value={userInfo.municipality_panchayath} icon="office-building" />
            <DetailIcon label="Ward No" value={userInfo.wardNo} icon="numeric" />
            <DetailIcon label="Place" value={userInfo.place} icon="home-map-marker" />
            <DetailIcon label="Land Mark" value={userInfo.landMark} icon="map-marker-radius" />
