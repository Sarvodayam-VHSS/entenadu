  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.description}>
        ...
        percentage, Sarvodayam also excels in extra-curricular activities. Also,
        units like ATL (Atal Tinkering Lab), JRC (Junior Red Cross), NSS
        (National Service Scheme), SPC (Student Police Cadet), Little Kites,
        Scouts & Guides add to the education.
      </Text>
    </ScrollView>
  );
};
